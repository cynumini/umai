...
pub const SQLITE_VERSION = "3.52.0";
pub const SQLITE_VERSION_NUMBER = __helpers.promoteIntLiteral(c_int, 3052000, .decimal);
pub const SQLITE_SOURCE_ID = "2026-03-06 16:01:44 557aeb43869d3585137b17690cb3b64f7de6921774daae9e56403c3717dcalt1";
pub const SQLITE_SCM_BRANCH = "trunk";
pub const SQLITE_SCM_TAGS = "release major-release version-3.52.0";
pub const SQLITE_SCM_DATETIME = "2026-03-06T16:01:44.367Z";
